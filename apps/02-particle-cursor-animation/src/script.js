...
displacement.glowImage.src = './paint2.png';
...
const particlesMaterial = new THREE.ShaderMaterial({
    ...
    uniforms:
    {
        ...
        uPictureTexture: new THREE.Uniform(textureLoader.load('./IMG_4706.png')),
...
const tick = () => {
    ...
    const glowSize = displacement.canvas.width * 0.3;
    displacement.context.globalCompositeOperation = 'lighten';
    displacement.context.globalAlpha = alpha;

    // move origin to cursor center
    displacement.context.translate(
        displacement.canvasCursor.x,
        displacement.canvasCursor.y
    );

    displacement.context.rotate(angle);

    // draw centered around rotated origin
